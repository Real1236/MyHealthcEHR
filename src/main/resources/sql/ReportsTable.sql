...
VALUES (
  ...
  "2023-05-05",
  "Progress Note",
  "Patient presented with complaints of abdominal pain and bloating for the past month. The pain was described as dull and constant, with intermittent sharp episodes. The patient denied any associated nausea, vomiting, or changes in bowel movements. Imaging studies were ordered, which revealed a small mass in the patient\''s pancreas measuring approximately 2 cm. The patient was informed of the findings, and is being referred to an oncologist for further evaluation and treatment. The differential diagnosis includes pancreatic cancer, neuroendocrine tumors, and cystic lesions, and a biopsy will likely be necessary to confirm the diagnosis. The patient was advised to follow up with their primary care physician regularly, and to report any new or worsening symptoms.",
  NULL,
  456,
  "",
  "",
  ...
  "2023-05-04",
  "Surgical Note",
  "Patient underwent routine laboratory testing, which revealed elevated levels of liver enzymes. Further evaluation was performed, and a diagnosis of non-alcoholic fatty liver disease was made. Lifestyle modifications and medical management were recommended, and the patient has shown improvement in subsequent follow-up visits.",
  NULL,
  789,
  "Cholelithiasis",
  ...
  "2023-05-03",
  "Radiology Report",
  "Patient presented with symptoms of depression and anxiety. A thorough evaluation was performed, and a diagnosis of generalized anxiety disorder and major depressive disorder was made. A treatment plan was developed that included medication and therapy, and the patient has shown improvement in their symptoms.",
  NULL,
  123,
  "",
  "",
